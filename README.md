...
- `--knowledge path.json|jsonl` to load a local player database.
...
```bash
python scripts/fetch_wikidata_names.py --output wikidata_players.jsonl
```
...
```bash
python scripts/extract_wikidata_players.py \
...
```bash
python3 scripts/build_players_enriched.py \
...
- **FBref (recent seasons)**  
  ...
  **Access points:** `data/fbref_2025_players.jsonl`, generated by `scripts/fetch_fbref_2025.py`
...
- **Transfermarkt (historical + market values)**  
  ...
  **Access points:** `data/transfermarkt_players.jsonl`, generated by `scripts/fetch_transfermarkt_kaggle.py`
...
- **FIFA player ratings**  
  ...
  **Access points:** `data/fifa_all_players.jsonl`, generated by `scripts/fetch_fifa_players.py`
...
- **World Cup players (historical)**  
  ...
  **Access points:** `data/worldcup_players.jsonl`, generated by `scripts/fetch_openfootball.py`

- **OpenFootball names**  
  **Description:** Broad name list (no attributes).  
  **Importance:** Low — name coverage only; useful as a fallback list.  
  **Access points:** `data/openfootball_players.jsonl`, generated by `scripts/fetch_openfootball.py`
...
- **Wikidata (optional, currently empty)**  
  ...
  **Access points:** `data/wikidata_players.jsonl`, generated by `scripts/fetch_wikidata_names.py` or `scripts/fetch_players_ranked.py`
